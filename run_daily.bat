...
start "" C:\Users\Sachio\AppData\Local\Programs\Python\Python313\python.exe app\populate_guidance_batch.py
start "" C:\Users\Sachio\AppData\Local\Programs\Python\Python313\python.exe app\populate_guidance_batch_asc.py

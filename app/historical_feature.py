...
columns = [
    ...
    # insider (optional – may remain NULL)
...
# =============================================================================
# 2. Load rows that still need features
# =============================================================================
df = pd.read_sql("SELECT * FROM ml_dataset WHERE quality_curr IS NULL", conn, parse_dates=['earnings_date'])

# =============================================================================
# 3. Cache price history and earnings dates per ticker
# =============================================================================
ticker_cache = {}
...
for counter, (idx, row) in enumerate(df.iterrows(), 1):
    ...
    """, (
        ...
        safe_get(pct_52w),            # handles dict or scalar
        consensus_proxy,
